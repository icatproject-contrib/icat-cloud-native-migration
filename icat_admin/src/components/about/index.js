const About = () => (
    <div class="page">
        ...
        <p class="mainContent">The source code for the site is available <a href="https://github.com/wonkyspecs/icat-admin">on github</a>. The site is built with <a href="icat_admin/src/components/about/index">Preact</a>, and is currently hosted by <a href="icat_admin/src/components/about/index">Netlify</a>.</p>
